...
SUITES="${BATTERY_SUITES:-integration_tests.js dn_strategy_tests.js dn_adapter_tests.js pyd_demand_tests.js dn_keeper_dryrun_test.js dn_keeper_unwind_test.js test_all.js}"
while [ $# -gt 0 ]; do
  case "$1" in
    --keep) KEEP=1 ;;
